...
public class BuffMeCommand extends Command {
    ...
    int[] all_buffs = {1001003,2001003,3001003,1101006,1101007,1201007,1301006,2101001,2201001,2301003,4201003,1311008,2111005,2211005,4111002,9101002,9101003,9101008,1121000,1121011,1221000,1221012,1321000,1321010,2121000,2121008,2221000,2221008,2321000,2321005,2321009,3121000,3121002,3121009,3221000,3221002,3221008,4121000,4121009,4221000,4221008,5221000,5221010,11101003,15110000,14101003,14111000,12001002,12101000,12101004,13001002,11001001,9001003,9001008,21121000,21121008,21121003};
    @Override
