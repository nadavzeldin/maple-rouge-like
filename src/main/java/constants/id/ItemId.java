...
public class ItemId {
    ...
    public static final int MERGE_COIN = 2022280;
    ...
    public static boolean isScroll(int itemId) {
        ...
        return (intInRange(itemId, 2040000, 2040031)
                || intInRange(itemId, 2040041, 2040046)
                || intInRange(itemId, 2040100, 2040109)
                || intInRange(itemId, 2040200, 2040209)
                || intInRange(itemId, 2040300, 2040331)
                || intInRange(itemId, 2040333, 2040340)
                || intInRange(itemId, 2040400, 2040427)
                || intInRange(itemId, 2040429, 2040436)
                || intInRange(itemId, 2040500, 2040534)
                || intInRange(itemId, 2040538, 2040543)
                || intInRange(itemId, 2040600, 2040627)
                || intInRange(itemId, 2040629, 2040636)
                || intInRange(itemId, 2040700, 2040723)
                || intInRange(itemId, 2040727, 2040742)
                || intInRange(itemId, 2040755, 2040760)
                || intInRange(itemId, 2040800, 2040826)
                || intInRange(itemId, 2040829, 2040834)
                || intInRange(itemId, 2040900, 2040912)
                || intInRange(itemId, 2040914, 2040933)
                || intInRange(itemId, 2040936, 2040943)
                ...
                || intInRange(itemId, 2043022, 2043025)
                || intInRange(itemId, 2043100, 2043108)
                || intInRange(itemId, 2043110, 2043114)
                || intInRange(itemId, 2043117, 2043120)
                || intInRange(itemId, 2043200, 2043208)
                || intInRange(itemId, 2043210, 2043214)
                || intInRange(itemId, 2043217, 2043220)
                || intInRange(itemId, 2043300, 2043308)
                || intInRange(itemId, 2043312, 2043313)
                || intInRange(itemId, 2043700, 2043708)
                || intInRange(itemId, 2043712, 2043713)
                || intInRange(itemId, 2043800, 2043808)
                || intInRange(itemId, 2043812, 2043813)
                || intInRange(itemId, 2044000, 2044008)
                || intInRange(itemId, 2044010, 2044015)
                || intInRange(itemId, 2044025, 2044028)
                || intInRange(itemId, 2044100, 2044108)
                || intInRange(itemId, 2044110, 2044114)
                || intInRange(itemId, 2044117, 2044120)
                || intInRange(itemId, 2044200, 2044208)
                || intInRange(itemId, 2044210, 2044214)
                || intInRange(itemId, 2044217, 2044220)
                || intInRange(itemId, 2044300, 2044308)
                || intInRange(itemId, 2044310, 2044314)
                || intInRange(itemId, 2044317, 2044320)
                || intInRange(itemId, 2044400, 2044408)
                || intInRange(itemId, 2044410, 2044414)
                || intInRange(itemId, 2044417, 2044420)
                || intInRange(itemId, 2044500, 2044508)
                || intInRange(itemId, 2044512, 2044513)
                || intInRange(itemId, 2044600, 2044608)
                || intInRange(itemId, 2044612, 2044613)
